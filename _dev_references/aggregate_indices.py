...
ALL_CORPORA = [
    ...
    'yugikyo',  # 2026-06-12 追加（瑜祇経 横断索引化・性霊集含め 13 著作目）
    'rishikyo',  # 2026-06-15 追加（理趣経 横断索引化・性霊集含め 14 著作目）
    'rishushaku',  # 2026-06-15 追加（理趣釈 横断索引化・性霊集含め 15 著作目）
    'hotsubodaishinron-sho-vol1',  # 2026-06-15 追加（発菩提心論鈔 第一巻 横断索引化・性霊集含め 16 著作目）
    'dainichikyo-sho-vol2',
    'dainichikyo-sho-vol3',
    'dainichikyo-sho-vol4',
    'dainichikyo-sho-vol5',  # 2026-06-19 追加（大日経疏 巻第五 横断索引化・29 著作目）
    'dainichikyo-sho-vol6',  # 2026-06-20 追加（大日経疏 巻第六 横断索引化・30 著作目）
    'dainichikyo-sho-vol7',  # 2026-06-20 追加（大日経疏 巻第七 横断索引化・31 著作目）
    'dainichikyo-sho-vol8',  # 2026-06-20 追加（大日経疏 巻第八 横断索引化・32 著作目）
    'dainichikyo-sho-vol9',  # 2026-06-20 追加（大日経疏 巻第九 横断索引化・33 著作目）
    'dainichikyo-sho-vol10',  # 2026-06-20 追加（大日経疏 巻第十 横断索引化・34 著作目）
    'dainichikyo-sho-vol11',  # 2026-06-20 追加（大日経疏 巻第十一 横断索引化・35 著作目）
    'dainichikyo-sho-vol12',  # 2026-06-22 追加（大日経疏 巻第十二 横断索引化・36 著作目）
    ...
    'dainichikyo-sho-vol17',  # 2026-06-24 追加（大日経疏 巻第十七 横断索引化・41 著作目）
    'dainichikyo-sho-vol18',  # 2026-06-24 追加（大日経疏 巻第十八 横断索引化・42 著作目）
    'dainichikyo-sho-vol19',  # 2026-06-25 追加（大日経疏 巻第十九 横断索引化・43 著作目）
    'dainichikyo-sho-vol20',  # 2026-06-25 追加（大日経疏 巻第二十 横断索引化・44 著作目）
    ...
    'hotsubodaishinron-sho-vol5',  # 2026-06-18 追加（発菩提心論鈔 第五巻 横断索引化・性霊集含め 21 著作目）
