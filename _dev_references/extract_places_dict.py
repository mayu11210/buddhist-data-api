...
DICT_CORPUS_LIST = [
    ...
    'dainichikyo-sho-vol2.json',
    'dainichikyo-sho-vol3.json',
    'dainichikyo-sho-vol4.json',
    'dainichikyo-sho-vol5.json',  # 2026-06-19 追加（大日経疏 巻第五 横断索引化・29 著作目）
    'dainichikyo-sho-vol6.json',  # 2026-06-20 追加（大日経疏 巻第六 横断索引化・30 著作目）
    'dainichikyo-sho-vol7.json',  # 2026-06-20 追加（大日経疏 巻第七 横断索引化・31 著作目）
    'dainichikyo-sho-vol8.json',  # 2026-06-20 追加（大日経疏 巻第八 横断索引化・32 著作目）
    'dainichikyo-sho-vol9.json',  # 2026-06-20 追加（大日経疏 巻第九 横断索引化・33 著作目）
    'dainichikyo-sho-vol10.json',  # 2026-06-20 追加（大日経疏 巻第十 横断索引化・34 著作目）
    ...
    'dainichikyo-sho-vol15.json',  # 2026-06-23 追加（大日経疏 巻第十五 横断索引化・39 著作目）
    'dainichikyo-sho-vol16.json',  # 2026-06-24 追加（大日経疏 巻第十六 横断索引化・40 著作目）
    'dainichikyo-sho-vol17.json',  # 2026-06-24 追加（大日経疏 巻第十七 横断索引化・41 著作目）
    'dainichikyo-sho-vol18.json',  # 2026-06-24 追加（大日経疏 巻第十八 横断索引化・42 著作目）
    'dainichikyo-sho-vol19.json',  # 2026-06-25 追加（大日経疏 巻第十九 横断索引化・43 著作目）
    'dainichikyo-sho-vol20.json',  # 2026-06-25 追加（大日経疏 巻第二十 横断索引化・44 著作目）
    ...
    'hotsubodaishinron-sho-vol9.json',
    'hotsubodaishinron-sho-vol10.json',  # 2026-06-18 追加（発菩提心論鈔 第十巻 横断索引化・26 著作目の dict 型）
]
