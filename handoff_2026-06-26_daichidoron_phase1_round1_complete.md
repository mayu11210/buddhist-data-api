...
- 追加済・validate OK（全て genten＋訳）：
  ...
  → 現在 **k005-k019（19段落）まで完了**。
- 残り（次バッチ以降、品の出現順。巻31本文は CBETA T1509_031 で取得可・会話履歴に全文あり）：
  畢竟空②（牢固の物も空＝金剛・七日喩経・須涅多羅＝仏の前身・無常は空の初門・栰喩経）→
  ...
  第一義空経・三乗の機＝鹿/犀/白象の譬）→不可得空→無法空・有法空・無法有法空（品の結び）。
